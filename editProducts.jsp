						...
						<form action="editProductsAction" method="post" enctype="multipart/form-data">
								...
								<div class="card-body">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="itemName" value="<%=rs.getString(3)%>">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control mb-1" name="itemPrice" value="<%=rs.getString(5)%>">

									</div>
									<div class="form-group">
										<label class="form-label">QUANTITY</label>
										<input type="text" class="form-control mb-1" name="itemQuantity" value="<%=rs.getString(6)%>">
